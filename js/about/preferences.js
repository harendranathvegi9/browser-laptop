...
class PaymentsTab extends ImmutableComponent {
  ...
  recoverWallet () {
    aboutActions.recoverWallet(this.state.FirstRecoveryKey, this.state.SecondRecoveryKey)
  }
  ...
  get ledgerRecoveryContent () {
    return <div className='board'>
      ...
      <div className='panel recoveryContent'>
        ...
        <SettingsList>
          <SettingItem>
            <h2 data-l10n-id='firstRecoveryKey' />
            <input onChange={this.handleFirstRecoveryKeyChange} type='text' />
            <h2 data-l10n-id='secondRecoveryKey' />
...
class AboutPreferences extends React.Component {
  constructor () {
    ...
    this.state = {
      ...
      ledgerRecoverySucceeded: false,
      ledgerRecoveryFailed: false
    }
    ...
    ipc.on(messages.LEDGER_RECOVER_SUCCEED, (e, body) => {
      console.log('succeeded')
      this.setState({ ledgerRecoverySucceeded: true })
    })
    ipc.on(messages.LEDGER_RECOVER_FAILED, (e, flashInstalled) => {
      this.setState({ ledgerRecoveryFailed: true })
    })
